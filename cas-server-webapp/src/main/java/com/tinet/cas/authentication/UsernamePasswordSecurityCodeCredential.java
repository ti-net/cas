 ...
 * @since 3.0
 */
public class UsernamePasswordSecurityCodeCredential implements Credential, Serializable {
     ...
     */
    public UsernamePasswordSecurityCodeCredential(final String userName, final String password) {
    ...
    public boolean equals(final Object o) {
        ...
        UsernamePasswordSecurityCodeCredential that = (UsernamePasswordSecurityCodeCredential) o;
        ...
        if (securityCode != null ? !securityCode.equals(that.securityCode) : that.securityCode != null) {
            return false;
        }
        return true;
    }
